...
## Ход работы:<br>
1. Получил API Ключ - ```90155849939f4eccaad753c3bfecf449```
2.
```c++
#include <iostream>
#include <string>
...
```
3. Получил погоду:![](https://sun1.43222.userapi.com/v5YMbIDA5emsrU-6YcjSW2fnJwg90Qej8FjEzA/vW3h277R5Pc.jpg)<br>Рис 1. Результат<br>
